              ...
              <table class="table table-striped table-hover">
                ...
                <?php foreach ($buku as $row) : ?>
                  <tr>
                    ...
                    <td><?= $row["stok"]; ?></td>
                    <td>
                      <img src="img/<?= $row["gambar"]; ?>" width="100" alt="Gambar buku">
                    </td>
                    <td><?= $row["kategori"]; ?></td>
                    <td><?= date('d-m-Y', strtotime($row["tanggal_input"])); ?></td>
                    <td>
                      <a href="ubah_data.php?id_buku=<?= $row["id_buku"]; ?>" class="btn-sm btn btn-success">Edit</a>
                      <a href="hapus_data.php?id_buku=<?= $row["id_buku"]; ?>"
